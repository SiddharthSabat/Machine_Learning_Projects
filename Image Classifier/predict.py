...
def parse_args():
    ...
    # If the input filepath for flower is not provided, default will be considered as king protea    
    parser.add_argument('--filepath', dest='filepath', default='flowers/test/13/image_05769.jpg') 
...
def main(): 
    ...
    probability = probs
    print('Selected File is: ' + img_path)
